/*!
 * @nuxt/webpack v2.14.3 (c) 2016-2020
...
const assetsMap = {};
const watcher = new EventEmitter__default['default']();
...
class ModernModePlugin {
  ...
  applyLegacy (compiler) {
    ...
    compiler.hooks.compilation.tap(ID, (compilation) => {
      HtmlWebpackPlugin__default['default'].getHooks(compilation).alterAssetTagGroups.tapAsync(ID, (data, cb) => {
  ...
  applyModern (compiler) {
    ...
    compiler.hooks.compilation.tap(ID, (compilation) => {
      HtmlWebpackPlugin__default['default'].getHooks(compilation).alterAssetTagGroups.tapAsync(ID, async (data, cb) => {
    ...
    if (!this.dev && splitChunks.name === undefined) {
      ...
      splitChunks.name = (_module, chunks, cacheGroup) => {
        ...
        if (compactName.length > 32) {
          compactName = hash__default['default'](compactName);
        }
